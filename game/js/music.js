...
(function($,window){
    ...
    DW.music = function(options) {
        var musicValue = {
            ...
            musicType:              ['纯音乐','华语','欧美','电音','韩国','爱乐之城','网络歌曲'],         //音乐的类型  （需要随机显示）这是结合我自己后台数据库使用的 如果不是用ajax请求是不会显示这个类型的;
            source:                 [
                                        {
                                            name:'If You Feel My Love (Chaow Mix)',
                                            singer:'Blaxy Girls',
                                            url:'http://m10.music.126.net/20180404151614/e779b20bfcfb6099694eec58c6d74b6a/ymusic/6b4c/60b3/d47b/0f30c171d87396277826fed2631542d7.mp3',
                                            img_url:'http://p1.music.126.net/SINO5vEtKeabpm8HnOr1BA==/789449348750555.jpg',
                                        },{
                                            name:'Just Like This (Original Mix)',
                                            singer:'Deepmaniak / The Chainsmokers / Coldplay',
                                            url:'http://m10.music.126.net/20180404152238/8f487a4e981e07ec26d9cc19dec86a84/ymusic/01eb/7055/5d75/4ed4300be45da21a4a09fa4a3326910b.mp3',
                                            img_url:'http://p1.music.126.net/UiKTv4h6ISD053jYucchjg==/109951163019318875.jpg',
                                        },{
                                            name:'Heartbeat (Nightcore) [PØRPEL Remix]',
                                            singer:'PØRPEL / Marcus & Martinus',
                                            url:'http://m10.music.126.net/20180404152630/66240fa5f2f4be1c9bc0be4040d11173/ymusic/ec17/b338/a13c/1ab8b3d81a6c6d6d5bcc45d0df9ae901.mp3',
                                            img_url:'http://p1.music.126.net/I_UDbIsryVrLsLfhgE85PA==/109951163044960154.jpg'
                                        },{
                                            name:'Don’t Wanna Know',
                                            singer:'Sam Tsui / Alex G',
                                            url:'http://m10.music.126.net/20180404152930/00a20e735d551c8b8dc076787c52feec/ymusic/bf81/150b/6dff/78694029a8643bb6eaebb74a633493c0.mp3',
                                            img_url:'http://p1.music.126.net/p_7aXCMoy77cdIbvwPVaAQ==/19100715997756928.jpg'
                                        }
                                    ],
        ...
        musicValue._init = function(){
            ...
            _this.music_name = $('<p class="music-name">青春</p>').appendTo(_this.music_info);
            ...
            _this.music_img = $('<img class="music-logo" src="http://1658946856.github.io/images/index/BM.jpg">').appendTo(_this.music_logo);
        ...
        */
        ...
        musicValue._insertData = function(data,index){
            var music_imgUrl = data[index].img_url || 'http://1658946856.github.io/images/index/BM.jpg';
            var music_name = data[index].name || '纯音乐';
            var music_url = data[index].url || 'http://m10.music.126.net/20180404153856/a13eef29622185ae2824079e0dec8437/ymusic/dda1/00f4/7b88/484d09cc58e898ce8c1d407041d2f994.mp3';
    ...
    $.fn.loading = function(options){
        ...
        return this.each(function(){
            ...
            var defaultProp = {
                ...
                // 这是图片的样式   (pic)
                imgSrc:                 'http://1658946856.github.io/images/index/BM_logo.jpg',       //默认的图片地址
